     ...
     <nav>
          <div className="navbar1">
            <div className="container nav-container">
                ...
                <div className="login">
            <button className='loginbtn'><Link className='link3' to={`/studentlogin`}>Login</Link> </button>
          </div>
        ...
        <div className='homeheadmain'>
            <div className='homehead'>The New Way To Learn Properly In With Us !</div>
            <div ><button className='loginbtn2'>Get Started</button></div>
...
<article className="information [ card2 ]">
...
<article className="information [ card2 ]">
    ...
    <p className="info">Always keep updated with this simple tool on the go, when and where ever you need.</p>
  ...
  <div className="gradient-cards">
    ...
    <div className="card1">
      <div className="container-card bg-blue-box">
        ...
        <div className="main-16-footer">
      <div className="main-16-sub">
        <div className="main-16-sub1">
          <div className="m16sub1h1">Address</div>
          <div><span><i className="fa fa-map-marker" aria-hidden="true"></i>  123 Street, New York, USA</span></div>
          <div><span><i className="fa fa-phone" aria-hidden="true"></i> +012 345 6789</span></div>
        ...
        <div className="main-16-sub3">
          <div className="m16sub1h1">Quick Links</div>
          <div className="m16s2"><i className="fa fa-angle-right" aria-hidden="true"></i> About Us</div>
          <div className="m16s2"><i className="fa fa-angle-right" aria-hidden="true"></i> Contact Us</div>
          <div className="m16s2"><i className="fa fa-angle-right" aria-hidden="true"></i> Our Services</div>
          <div className="m16s2"><i className="fa fa-angle-right" aria-hidden="true"> </i> Terms & Condition</div>
          <div className="m16s2"><i className="fa fa-angle-right" aria-hidden="true"></i>   Support</div>
        </div>
        <div className="main-16-sub3">
          <div className="m16sub1h1">Newsletter</div>
          <div className="m16s3"><p>Dolor amet sit justo amet elitr clita ipsum elitr est.</p></div>
          <div className="">

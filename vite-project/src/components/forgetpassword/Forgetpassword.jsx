        ...
        <div className='head2'>Forget Username</div>
			<form className="login2 " onSubmit={editPwd}>
				...
				<div className="login__field">
					...
					<input type="text" className="login__input3" name='phone'  onChange={handlechange}  placeholder="Enter  Your Phone Number"/>
				</div>
                <div className="login__field">
					<i className="login__icon fas fa-user"></i>
					<input type="text" className="login__input3" name='email'  onChange={handlechange}  placeholder="Enter  E-mail"/>
				</div>
                <div className="login__field">
					<i className="login__icon fas fa-user"></i>
					<input type="text" className="login__input3" name='password' onChange={handlechange}  placeholder="Enter New Password"/>
				</div>
